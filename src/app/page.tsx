      ...
      {loading ? (
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="mt-4 text-gray-600">Memuat proyek trending...</p>
          </div>
        </section>
      ) : (
        <div id="projects">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-6 max-w-md">
                Platform crowdfunding terpercaya yang menghubungkan para inovator dengan donatur untuk mewujudkan impian bersama.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center hover:bg-emerald-200 transition-colors">
                ...
                <a href="#" className="w-10 h-10 bg-pink-100 text-pink-600 rounded-full flex items-center justify-center hover:bg-pink-200 transition-colors">
                  <span className="text-sm font-bold">ig</span>
                </a>
              </div>
            </div>
            <div>
              <h5 className="font-bold text-gray-900 mb-4">Platform</h5>
              <ul className="space-y-3 text-gray-600">
                <li><a href="#" className="hover:text-emerald-600 transition-colors">Cara Kerja</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition-colors">Biaya Platform</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition-colors">Tips Sukses</a></li>
                <li><a href="#" className="hover:text-emerald-600 transition-colors">Blog</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-gray-900 mb-4">Dukungan</h5>
              <ul className="space-y-3 text-gray-600">
                ...
                <li><a href="#" className="hover:text-emerald-600 transition-colors">Laporan</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-500 text-sm">
                &copy; 2025 FundMyProject. Semua hak cipta dilindungi.
              </p>
